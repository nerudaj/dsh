...
namespace cfg {
	...
	public:
		 ...
		 *  might be followed by a special symbol ':'. It means that
		 *  argument requires the value.
		 *
		 *  For example following \p argarray "hg:i:" means:
		 *  program [-h] [-g <value>] [-i <value>]
		 */
		 ...
		 *
		 *  \details Use this check prior to calling
		 *  \ref getArgumentValue on optional arguments.
		 */
